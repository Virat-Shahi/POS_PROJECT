...
const TableManagement = () => {
    ...
    const handleTableClick = async (tableId, isOccupied) => {
        console.log(`Clicking table ${tableId}, current status: ${isOccupied}`);
        await actionUpdateTable(tableId, isOccupied);
    };
            ...
            <div className="flex flex-wrap -mx-3">
                {tables.map((table) => (
                    <Link
                        ...
                        onClick={() => handleTableClick(table.id, !table.isOccupied)}
                    >
